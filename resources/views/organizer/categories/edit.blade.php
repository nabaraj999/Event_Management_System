<x-organizer.organizer-layout title="Edit Category">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white shadow-2xl rounded-xl overflow-hidden">
            ...
            <form action="{{ route('org.categories.update', $category) }}" method="POST" class="p-8 space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <select name="icon_type" id="icon_type" onchange="toggleIconInput()"
                                class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#FF7A28]">
                            <option value="fontawesome" {{ old('icon_type', $category->icon_type) === 'fontawesome' ? 'selected' : '' }}>Font Awesome</option>
                    ...
                    <div id="icon_name_wrapper" style="{{ $category->icon_type === 'custom' ? 'display:none' : '' }}">
                ...
                <div id="custom_svg_wrapper" style="{{ $category->icon_type !== 'custom' ? 'display:none' : '' }}">
