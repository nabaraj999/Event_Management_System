        ...
        <div class="bg-[#063970] text-white rounded-xl shadow-md p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p class="text-blue-100 text-sm mt-1 opacity-90">Manage your event categories</p>
                </div>

                <div class="flex flex-wrap items-center gap-3">
                    <form method="GET" action="{{ route('org.categories.index') }}" class="flex gap-2 min-w-[240px]">
