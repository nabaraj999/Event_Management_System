                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number"
                                   ...
                                   name="price"
                                   id="price"
                                   value="{{ old('price', $eventTicket->price) }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number"
                                   name="total_seats"
                                   id="total_seats"
                                   value="{{ old('total_seats', $eventTicket->total_seats) }}"
                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="datetime-local"
                                   name="sale_start"
                                   id="sale_start"
                                   value="{{ old('sale_start', $eventTicket->sale_start?->format('Y-m-d\TH:i')) }}"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="datetime-local"
                                   name="sale_end"
                                   id="sale_end"
                                   value="{{ old('sale_end', $eventTicket->sale_end?->format('Y-m-d\TH:i')) }}"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary">
                            @error('sale_end')
                                <span class="text-red-600 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number"
                                   name="sort_order"
                                   id="sort_order"
                                   value="{{ old('sort_order', $eventTicket->sort_order) }}"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary">
                        </div>
                    </div>
                </div>
