...
<body class="font-raleway bg-gray-50">
    ...
    @endif
                ...
                @else
                    ...
                    <div class="relative group">
                        <button class="flex items-center space-x-3 text-gray-700 focus:outline-none">
                            <div
                                class="w-10 h-10 bg-darkBlue rounded-full flex items-center justify-center text-white text-lg font-bold">
                        ...
                        <div
                            ...
                            <a href="{{ route('user.profile.edit') }}"
                                class="block px-4 py-2 text-gray-700 hover:bg-gray-100 hover:text-primary transition">My
                                Profile</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-200 px-6 py-4">
            ...
            <a href="{{ route('organizer.apply') }}" class="block py-2 hover:text-primary transition">Become an
                Organizer</a>
