...
<div class="flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-darkBlue text-white z-50 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="{{ route('admin.events.index') }}" class="sidebar-link flex items-center px-4 py-3 rounded-lg transition">
            ...
            <a href="{{ route('admin.profile') }}" class="sidebar-link flex items-center px-4 py-3 rounded-lg transition">
                <svg class="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 20 20">
