...
<x-admin.admin-layout>
    ...
    <div class="py-8 px-4 max-w-6xl mx-auto">
        ...
        @if (session('success'))
            <div
                class="mb-8 p-6 bg-green-100 border-2 border-green-600 text-green-800 rounded-2xl shadow-lg text-center">
        ...
        @if ($settlement?->settled_at)
            <div class="bg-green-50 border-4 border-green-600 rounded-2xl p-12 text-center mb-10">
                <svg class="mx-auto h-24 w-24 text-green-600 mb-6" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                        ...
                        <tbody>
                            @forelse($ticketSales as $sale)
                                <tr class="border-b border-gray-100">
                                    ...
                                    <td class="text-right font-semibold">Rs. {{ number_format($sale['subtotal']) }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
                ...
                <div class="bg-white rounded-2xl shadow-2xl p-10">
                    ...
                    <form action="{{ route('admin.settlements.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" name="settlement_invoice_id" required
                                placeholder="e.g., BANK-2025-001"
