...
<x-admin.admin-layout title="Event Tickets">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        <div class="bg-white shadow-2xl rounded-2xl overflow-hidden">
            ...
            <!-- ❗ Search Error Message (ADDED) -->
            @if(request('search') && $tickets->count() === 0)
                <div class="mx-6 lg:mx-8 mt-4 lg:mt-4 bg-red-50 border-l-4 border-red-600 text-red-800 px-5 py-4 rounded-r-lg text-sm lg:text-base">
                    No results found for "<strong>{{ request('search') }}</strong>". Try another keyword.
                </div>
            @endif
