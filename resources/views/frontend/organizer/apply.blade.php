    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
                Join our platform and start creating amazing events. Fill in your organization details below to get
                started.
            </p>
        </div>
                        ...
                        <div>
                            ...
                            <select name="company_type" id="company_type" required
                                ...
                                <option value="private_limited"
                                    {{ old('company_type') == 'private_limited' ? 'selected' : '' }}>Private Limited
                                    Company</option>
                                <option value="public_limited"
                                    {{ old('company_type') == 'public_limited' ? 'selected' : '' }}>Public Limited
                                    Company</option>
                                <option value="ngo" {{ old('company_type') == 'ngo' ? 'selected' : '' }}>NGO /
                                    Non-Profit</option>
                                <option value="partnership"
                                    {{ old('company_type') == 'partnership' ? 'selected' : '' }}>Partnership Firm
                                </option>
                                <option value="sole_proprietorship"
                                    {{ old('company_type') == 'sole_proprietorship' ? 'selected' : '' }}>Sole
                                    Proprietorship</option>
                                <option value="event_agency"
                                    {{ old('company_type') == 'event_agency' ? 'selected' : '' }}>Event Management
                                    Agency</option>
