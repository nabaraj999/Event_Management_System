                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden transform transition hover:-translate-y-2 hover:shadow-2xl duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 flex gap-3">
                            <a href="{{ route('events.show', $event) }}" class="px-4 py-2 border border-primary rounded-lg text-primary font-semibold hover:bg-primary hover:text-white transition">View Details</a>
                            <a href="{{ route('events.show', $event) }}" class="px-4 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-darkBlue transition">Book Now</a>
                        </div>
                    </div>
                </div>
            @empty
